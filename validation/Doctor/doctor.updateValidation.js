...
updateDoctorValidation:{
    body:joi.object().required().keys({
      ...
      specialization:joi.string().empty().optional().min(8).max(15).messages({
        "string.base":"please enter a valid specialization ",
        "string.empty":"specialization cannot be empty",
        "string.min":"no of characters must be between 8 and 15",
        "string.max":"no of characters must be between 8 and 15",
      }),
      ...
      department:joi.string().empty().optional().messages({
