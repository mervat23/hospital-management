...
createPatientValidation:{
    body:joi.object().required().keys({
      ...
      gender:joi.string().empty().required().min(1).max(6).messages({
        "string.base":"please enter a valid gender ",
        "string.empty":"gender cannot be empty",
        "any.required":"gender must be entered",
        "string.min":"no of characters must be between 1 and 6",
        "string.max":"no of characters must be between 1 and 6",
      }),
